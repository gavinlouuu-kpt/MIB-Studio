...
cv::Mat processFrame(const std::vector<uint8_t> &imageData, size_t width, size_t height, SharedResources &shared)
{
    ...
    static thread_local cv::Mat original;
    static thread_local cv::Mat blurred_target;
    static thread_local cv::Mat bg_sub;
    static thread_local cv::Mat binary;
    static thread_local cv::Mat dilate1, erode1, erode2, dilate2;
